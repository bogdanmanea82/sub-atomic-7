...
// Integration tests for the ItemModifier JSON API (GET/POST/PUT/DELETE /api/modifiers).
...
import { ItemModifierController } from "../../../../src/controller/entities/item-modifier";
import { getConnection } from "../../../../src/model-service/sub-atoms/database";

const ADMIN_TOKEN = "Bearer dev-admin-token";
const BASE = "http://localhost";

const app = new Elysia().use(ItemModifierController);
