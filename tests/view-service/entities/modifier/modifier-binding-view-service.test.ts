...
import { ModifierBindingViewService } from "../../../../src/view-service/entities/modifier/modifier-binding-view-service";
...
describe("ModifierBindingViewService.preparePanel", () => {
  // ── Empty input ────────────────────────────────────────────────────────────

  it("returns an empty array for empty bindings", () => {
    const result = ModifierBindingViewService.preparePanel([], categoryLookup, subcategoryLookup);
  ...
  it("passes through id unchanged", () => {
    const result = ModifierBindingViewService.preparePanel(
  ...
  it("extracts is_included as a boolean", () => {
    const included = ModifierBindingViewService.preparePanel(
    ...
    const excluded = ModifierBindingViewService.preparePanel(
