...
import { ModifierAssignmentViewService } from "../../../../src/view-service/entities/modifier/modifier-assignment-view-service";
...
describe("Rule 3 — no binding on subcategory or parent category", () => {
  it("assigns status 'none' and source 'none'", () => {
    const result = ModifierAssignmentViewService.preparePanel(
      [], [], [CAT_A], [SUB_A1],
    );
