...
describe("MODIFIER_TIER_CONFIG", () => {
  ...
  it("has correct table name (snake_case)", () => {
    expect(MODIFIER_TIER_CONFIG.tableName).toBe("item_modifier_tier");
  });

  it("has correct display names", () => {
    expect(MODIFIER_TIER_CONFIG.displayName).toBe("Item Modifier Tier");
    expect(MODIFIER_TIER_CONFIG.pluralDisplayName).toBe("Item Modifier Tiers");
  });
