...
export const ModifierBindingApi = new Elysia()
  ...
  .get("/api/modifiers/:id/bindings", async ({ params }) => {
    ...
    const bindings = await ModifierBindingService.findByModifier(modifierId);
  ...
  .post("/api/modifiers/:id/bindings", async ({ params, body, set }) => {
    ...
    const result = await ModifierBindingService.create(modifierId, input);
  ...
  .put("/api/modifiers/:id/bindings/:bindingId", async ({ params, body, set }) => {
    ...
    const result = await ModifierBindingService.update(modifierId, bindingId, data);
  ...
  .delete("/api/modifiers/:id/bindings/:bindingId", async ({ params, set }) => {
    ...
    const modifierId = p["id"] as string;
    const bindingId = p["bindingId"] as string;
    const result = await ModifierBindingService.remove(modifierId, bindingId);
