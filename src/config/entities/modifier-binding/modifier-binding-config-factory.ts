// src/config/entities/modifier-binding/modifier-binding-config-factory.ts
// Factory for ModifierBinding entity configuration.
// Bindings are subordinate to Modifier — no independent routes.
...
export class ModifierBindingConfigFactory extends BaseEntityConfigFactory {
  ...
  protected getDisplayName(): string {
    return "Modifier Binding";
  }

  protected getPluralDisplayName(): string {
    return "Modifier Bindings";
  }
...
export const MODIFIER_BINDING_CONFIG = new ModifierBindingConfigFactory().create();
