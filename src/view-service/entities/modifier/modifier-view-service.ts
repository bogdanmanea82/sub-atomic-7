// src/view-service/entities/item-modifie./modifier-view-service.ts
...
export const ModifierViewService = {
  ...
  prepareFilteredListView(
    ...
    const view = buildListView(entities, MODIFIER_CONFIG, referenceLookup, pagination);
  ...
  parseTiersJsonForRerender(input: Record<string, unknown>): readonly TierFormRow[] {
    ...
    try {
      ...
      return ModifierViewService.tiersToFormRows(parsed);
    } catch {
      return [];
    }
  },
