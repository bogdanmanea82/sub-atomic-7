...
-- Raw variant: creates modifier + tiers only — NO binding inserted.
-- Returns the modifier UUID so the caller can insert any number of bindings manually.
-- Use this for multi-binding, exclusion, or cross-category patterns.
